---
name: verify-falsify
description: Standalone falsification gate — search for a numeric counterexample to a single mathematical claim and record a certificate-backed REFUTED / PASSED / VACUOUS / SKIPPED outcome
user_invocable: true
---
