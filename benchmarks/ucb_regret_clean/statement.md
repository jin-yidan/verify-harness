# UCB1 Regret Bound (Auer–Cesa-Bianchi–Fischer 2002, Theorem 1)

Source: Peter Auer, Nicolò Cesa-Bianchi, Paul Fischer, "Finite-time Analysis
of the Multiarmed Bandit Problem," Machine Learning, 47:235–256, 2002.
Theorem 1, canonical formulation (cf. Lattimore & Szepesvári, "Bandit
Algorithms," 2020).
...
$$\Big[ 8 \sum_{i\,:\,\mu_i < \mu^*} \frac{\ln n}{\Delta_i} \Big]
...
$\ell = \lceil 8 \ln n / \Delta_i^2 \rceil$. Then
...
**Step 7 (Combine).** $\mathbb{E}[T_i(n)] \le \lceil 8 \ln n / \Delta_i^2
\rceil + \frac{\pi^2}{3} \le 8 \ln n / \Delta_i^2 + 1 + \frac{\pi^2}{3}$.
