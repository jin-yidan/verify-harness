...
description: Standalone hypothesis audit — at every point one block invokes another, list ALL hypotheses of the invoked result and check each against the actual argument; catch missed/substituted hypotheses and cycles hidden by conditional conclusions
user_invocable: true
---
