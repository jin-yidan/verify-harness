...
description: Standalone assemble + kernel audit — compile the fully-discharged file and read its #print axioms closure, the verdict source of truth that catches sorries and axioms hidden in imports
user_invocable: true
---
