---
name: formalize
description: Formalize a mathematical theorem in Lean 4 with online verification, anti-vacuity checks, and honest labeling
user_invocable: true
---
...
This is how the library grows: each formalized theorem becomes a building block that future papers can resolve against automatically. The engine's resolve step (Phase 2) uses embedding retrieval over this corpus to match proof building blocks to existing library theorems.
